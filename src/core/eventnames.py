__all__ = [
    ...
    'END_TURN', 'FRIEND_AHEAD_ATTACKS', 'FRIEND_AHEAD_FAINTS',
    'FRIEND_BOUGHT', 'FRIEND_EATS_FOOD', 'FRIEND_FAINTS',
    'FRIEND_SOLD', 'FRIEND_SUMMONED_BATTLE', 'FRIEND_SUMMONED_SHOP',
    'HURT', 'IS_SUMMONED', 'KNOCK_OUT', 'ON_FAINT', 'ON_LEVEL',
    'SELL', 'START_BATTLE', 'START_TURN'
]
